  ...
  return (
    <>
      ...
      <section  className=' h-screen  bg-[url(task2pic.jpg)] bg-cover  p-15  '>
        <h1 className=' text-3xl'>alexa peterson</h1>
        <br /> <br /> <br /> 
        ...
        <button className='field-sizing-content border-0 rounded-md p-1  text-white font-bold bg-orange-400  m-1 '> SIGN ME UP! </button>
        <br /> <br /> 

        <div className=' text-white text-3xl flex ' > 
        < AiOutlineTwitter  className=' ' /> &ensp;  
        < AiFillInstagram className='  ' />  &ensp;  
        < BiLogoFacebookSquare className=' rounded-1xl ' />
        </div> 
